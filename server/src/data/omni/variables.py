...
omni_variables = [
	...
	OmniVariable('By', GROUP.IMF, omniweb_name='By,GSE', noaa_name='by_gse'),
	OmniVariable('Bz', GROUP.IMF, omniweb_name='Bz,GSE', noaa_name='bz_gse'),
	OmniVariable('By_gsm', GROUP.IMF, omniweb_name='By,GSM', crs_name='ibz', noaa_name='by_gsm'),
	OmniVariable('Bz_gsm', GROUP.IMF, omniweb_name='Bz,GSM', crs_name='iby', noaa_name='bz_gsm'),
