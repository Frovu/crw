		...
		sources: {
			...
			tree: {
				...
				sources0: {
					split: 'row',
					ratio: 0.5,
					children: ['insertCtr', 'cmes'],
				},
				column01top: {
					split: 'column',
					ratio: 0.5,
					children: ['column01top0', 'column01top1'],
				},
				column01bottom: {
					split: 'row',
					ratio: 0.7,
					children: ['eruptions', 'icmes'],
				},
				column0: {
					split: 'row',
					ratio: 0.6,
					children: ['column01', 'columnPlots'],
				},
				column1: {
					split: 'column',
					ratio: 0.6,
				...
				sunParams: {
					split: 'column',
					ratio: 0.4,
					children: ['sunParams0', 'sunParamsBottom'],
				},
				sunParamsBottom: {
					split: 'column',
					ratio: 0.4,
					children: ['sunParams1', 'sunParams2'],
				},
				column01: {
					split: 'column',
					ratio: 0.8,
					children: ['column01top', 'column01bottom'],
				},
				columnPlots: {
					split: 'column',
					ratio: 0.3,
					children: ['plots0', 'plots1'],
				},
				plots0: {
					split: 'column',
					ratio: 0.6,
					children: ['plot0', 'plot1'],
				},
				plots1: {
					split: 'column',
					ratio: 0.8,
					children: ['plots2', 'plot4'],
				},
				plots2: {
					split: 'column',
					ratio: 0.5,
					children: ['plot2', 'plot3'],
				},
				column01top1: {
					split: 'row',
					ratio: 0.7,
					children: ['sources0', 'flares'],
				},
				column01top0: {
					split: 'row',
					ratio: 0.5,
					children: ['mainTable', 'chSquare'],
				},
				chSquare: {
					split: 'column',
					ratio: 0.2,
					children: ['chTop', 'chBottom'],
				},
				chBottom: {
					split: 'row',
					ratio: 0.44,
					children: ['chLeft', 'chRight'],
				},
			},
			items: {
				sdo0: {
