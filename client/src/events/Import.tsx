...
export default function ImportMenu() {
	...
	return !open ? null : (
		<>
			...
			<div
				className="Popup"
				style={{ left: 4, padding: '16px 32px 8px 32px', border: '2px var(--color-border) solid' }}
						...
						return (
							<div style={{ textAlign: 'left', lineHeight: 1.5 }}>
								...
								<div style={{ margin: '8px 8px 4px 0' }}>
									<div
										style={{
											color: report?.success ? 'var(--color-green)' : 'var(--color-red)',
									...
									<button
										style={{ width: 110, margin: 4, verticalAlign: 'top' }}
										disabled={isPending}
										onClick={() =>
											mutate(parsed.parsed, {
