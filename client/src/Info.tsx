import { KEY_COMB, useAppSettings } from './app';
...
export default function Help() {
	...
	return <>
		...
		<div className='Popup' style={{ padding: '1em 2em 20em 3em', top: 8, left: 8,
			overflowY: 'auto', maxHeight: 'calc(100vh - 32px)', maxWidth: '80ch', textAlign: 'justify' }}>
