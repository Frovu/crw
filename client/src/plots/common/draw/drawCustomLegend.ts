...
import { applyOverrides, scaled, getFontSize, color, withCapturedOverrides } from '../plotUtil';
...
export function drawCustomLegend({
	...
	return withCapturedOverrides((u: Omit<uPlot, 'series'> & { series: CustomSeries[] }) => {
